...
class Organisation extends Remote\Object
{
    ...
    {
        return array(
            'APIKey' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'Name' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'LegalName' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'PaysTax' => array (false, self::PROPERTY_TYPE_BOOLEAN, null, false, false, false),
            'Version' => array (false, self::PROPERTY_TYPE_ENUM, null, false, false, false),
            'BaseCurrency' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'CountryCode' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'IsDemoCompany' => array (false, self::PROPERTY_TYPE_BOOLEAN, null, false, false, false),
            'OrganisationStatus' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'RegistrationNumber' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'TaxNumber' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'FinancialYearEndDay' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'FinancialYearEndMonth' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'SalesTaxBasis' => array (false, self::PROPERTY_TYPE_ENUM, null, false, false, false),
            'SalesTaxPeriod' => array (false, self::PROPERTY_TYPE_ENUM, null, false, false, false),
            'PeriodLockDate' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'EndOfYearLockDate' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'CreatedDateUTC' => array (false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', false, false, false),
            'OrganisationEntityType' => array (false, self::PROPERTY_TYPE_ENUM, null, false, false, false),
            'Timezone' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'ShortCode' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'LineOfBusiness' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            ...
            'ExternalLinks' => array (false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Organisation\\ExternalLink', true, false, false),
