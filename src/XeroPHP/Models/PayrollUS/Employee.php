...
class Employee extends Remote\Object
{
    ...
    {
        return array(
            'FirstName' => array (true, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'LastName' => array (true, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'DateOfBirth' => array (true, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', false, false, false),
            'HomeAddress' => array (true, self::PROPERTY_TYPE_OBJECT, 'PayrollUS\\Employee\\HomeAddress', false, false, false),
            'MiddleNames' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'JobTitle' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'Email' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'Gender' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'MailingAddress' => array (false, self::PROPERTY_TYPE_OBJECT, 'PayrollUS\\Employee\\MailingAddress', false, false, false),
            'Phone' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'EmployeeNumber' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'SocialSecurityNumber' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'StartDate' => array (false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', false, false, false),
            'TerminationDate' => array (false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', false, false, false),
            'PayScheduleID' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'EmployeeGroupName' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'EmploymentBasis' => array (false, self::PROPERTY_TYPE_ENUM, null, false, false, false),
            'HolidayGroupID' => array (false, self::PROPERTY_TYPE_STRING, null, false, false, false),
            'IsAuthorisedToApproveTimeOff' => array (false, self::PROPERTY_TYPE_BOOLEAN, null, false, false, false),
            'IsAuthorisedToApproveTimesheets' => array (false, self::PROPERTY_TYPE_BOOLEAN, null, false, false, false),
            'SalaryAndWages' => array (false, self::PROPERTY_TYPE_OBJECT, 'PayrollUS\\Employee\\SalaryAndWage', true, false, false),
            'WorkLocations' => array (false, self::PROPERTY_TYPE_OBJECT, 'PayrollUS\\Employee\\WorkLocation', true, false, false),
            'PaymentMethod' => array (false, self::PROPERTY_TYPE_OBJECT, 'PayrollUS\\Employee\\PaymentMethod', false, false, false),
            'PayTemplate' => array (false, self::PROPERTY_TYPE_OBJECT, 'PayrollUS\\Employee\\PayTemplate', false, false, false),
            'OpeningBalances' => array (false, self::PROPERTY_TYPE_OBJECT, 'PayrollUS\\Employee\\OpeningBalance', true, false, false),
            'TimeOffBalances' => array (false, self::PROPERTY_TYPE_OBJECT, 'PayrollUS\\Employee\\TimeOffBalance', true, false, false),
